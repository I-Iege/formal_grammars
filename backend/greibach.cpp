...
std::string greibach::to_string() const { return g[alg_it].to_string(); }
...
const grammar& greibach::get_grammar() const { return g[alg_it]; }

const grammar& greibach::get_result() const { return g.back(); }
